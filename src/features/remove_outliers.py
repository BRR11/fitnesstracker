...
# --------------------------------------------------------------
df[["acc_x"]].boxplot()
df[["gyr_y","label"]].boxplot(by = "label")
df[outlier_columns[:3]+["label"]].boxplot(by="label")
df[outlier_columns[3:]+["label"]].boxplot(by="label")
...
dataset.loc [dataset ["gyr_z_outlier"], "gyr_2"] = np.nan
...
outliers_removed_df.to_pickle("/Users/rishanthreddy/Desktop/Tracking barbell Exercises/data/interim/outliers_removed_chauvenets")
